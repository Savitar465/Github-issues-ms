...
public class GlobalExceptionHandler {
    ...
    // ===== 400 - JSON ilegible / enum inválido en cuerpo =====
    ...
    public ResponseEntity<ErrorResponse> handleNotReadable(
        ...
        return ResponseEntity.badRequest().body(
                ErrorResponse.of(400, "Bad Request", msg, request.getRequestURI())
        );
    }
    ...
    // ===== 400 - Argumento ilegal (ej: valor de enum inválido en query param) =====
